...
def n2w_large_number(numbers: str):
    ...
    for e in range(0, len(reversed_large_number)):
        ...
        if e == 1:
            ...
            if value_of_thousand in ['000', '00', '0']:
                total_number.append(n2w_hundreds(value_of_thousand))
            else:
                total_number.append(n2w_hundreds(value_of_thousand) + ' nghìn ')
        if e == 2:
            value_of_million = reversed_large_number[2][::-1]
            if value_of_million in ['000', '00', '0']:
                total_number.append(n2w_hundreds(value_of_million))
            else:
                total_number.append(n2w_hundreds(value_of_million) + ' triệu ')
        if e == 3:
            value_of_billion = reversed_large_number[3][::-1]
            if value_of_billion in ['000', '00', '0']:
                total_number.append(n2w_hundreds(value_of_billion))
            else:
...
def n2w(number: str):
    ...
    return (n2w_large_number(clean_number) + ' đồng chẵn').capitalize()
